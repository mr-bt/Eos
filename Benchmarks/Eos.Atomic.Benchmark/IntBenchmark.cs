...
{
    public static class IntBenchmark
    {
        private static readonly object LockObj = new object();
        private static int _interlocked;
        private static AtomicInt _atomic;
        private static AtomicIntPadded _atomicPadded;
        private static int _shared;

        public static void Execute(int totalOfTasks, int expectedTotalIterations)
        {
            Console.WriteLine("Integer benchmark\n");
            ...
            Profiler.Profiles(
                ...
                () =>
                {
                    ...
                    _atomicPadded = new AtomicIntPadded();
