...
namespace Eos.Atomic.Tests
{
    ...
    public class AtomicIntTests
    {
       ...
       {
           var value = new AtomicInt(int.MaxValue);
       ...
       {
           var value = new AtomicInt(int.MinValue);
        ...
        [Test]
        public void EqualsAtomicIntInputShouldReturnTrueOnSameValue()
        {
            var value1 = new AtomicInt(5);
            var value2 = new AtomicInt(5);

            Assert.IsTrue(value1.Equals(value2));
        }

        [Test]
        public void EqualsAtomicIntInputShouldReturnFalseOnDifferentValue()
        {
            var value1 = new AtomicInt(1);
            var value2 = new AtomicInt(2);
        ...
        {
            var value1 = (object)new AtomicInt(1);
            var value2 = (object)new AtomicInt(1);
        ...
        {
            var value1 = (object)new AtomicInt(1);
            var value2 = (object)new AtomicInt(2);
